...
const ENDGAME_DRILLS = [
    ...
    { id: 'twobishops', name: 'Two-bishop mate', goal: 'win', side: 'w',
      fen: '8/8/8/4k3/8/8/8/2B1KB2 w - - 0 1',
      tip: 'The bishops work side by side, sweeping diagonals like a wall. Herd the king to a corner and keep your own king close.' },
    { id: 'outside', name: 'Outside passed pawn', goal: 'win', side: 'w',
      fen: '8/4kppp/8/8/P7/8/5PPP/4K3 w - - 0 1',
      tip: 'The a-pawn is a decoy: march it, drag the defending king across the board, then raid the kingside pawns with your own king.' },
    { id: 'qvr', name: 'Queen vs rook', goal: 'win', side: 'w',
      fen: '4k2r/8/8/8/8/8/8/3QK3 w - - 0 1',
      tip: 'Drive king and rook together, then win the rook with a fork or zugzwang. If the rook strays from its king, fork them at once.' },
    { id: 'wrongbishop', name: 'Wrong bishop: hold the draw', goal: 'draw', side: 'b',
      fen: 'k7/8/P7/8/8/8/8/2B1K3 b - - 0 1',
      tip: 'The dark-squared bishop can\'t control a8, so the pawn can\'t be escorted home. Keep your king glued to the corner — a8, b8, a7.' },
    { id: 'kbn', name: 'Bishop & knight mate', goal: 'win', side: 'w',
      fen: '8/8/8/4k3/8/8/8/4KBN1 w - - 0 1',
      tip: 'The hardest basic mate: the king only mates in a corner the bishop controls. Use the knight\'s "W" path to herd it there — and mind the fifty-move rule.' },
  ];
